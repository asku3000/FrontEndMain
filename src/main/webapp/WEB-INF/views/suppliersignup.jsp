...
<body>
	...
	<div class="container"
		style="background: #ECEFF1; width: 100%; height: 2100px; margin: 10px 0 0 0;">
		<div class="container-fluid "
			style="background: #FAFAFA; border: 1px solid #455A64; border-radius: 50px; height: 1800px; width: 600px; margin-top: 70px">
			...
			<sf:form modelAttribute="user">
				...
				<sf:input path="email" class="input-xlarge"
				...
				<sf:label path="password">Repeat Password<span
						class="text-danger">*</span> :</sf:label>
				<sf:password path="password" class="input-xlarge" id="pass2"
					onblur="return check()" />
				<br />
				<!-- to display validation messages -->
				<jstlc:forEach
				...
				<hr>
				<sf:label path="supplier_companyName">Company Name<span
						class="text-danger">*</span> :</sf:label>
				<sf:input path="supplier_companyName" class="input-xlarge" />
				<br />
				<!-- to display validation messages -->
				<jstlc:forEach
					items="${flowRequestContext.messageContext.getMessagesBySource('supplier_companyName')}"
					var="err">
					<div>
						<span class="text-danger">${err.text}</span>
					</div>
				...
				<hr>
				<sf:label path="supplier_brandName">Company Brand Name<span
						class="text-danger">*</span> :</sf:label>
				<sf:input path="supplier_brandName" class="input-xlarge" />
				<br />
				<!-- to display validation messages -->
				<jstlc:forEach
					items="${flowRequestContext.messageContext.getMessagesBySource('supplier_brandName')}"
					var="err">
					<div>
						<span class="text-danger">${err.text}</span>
					</div>
				...
				<sf:input path="address" class="input-xlarge"
					placeholder="How bookbag can reach to you" />
				<br />
				<!-- to display validation messages -->
				<jstlc:forEach
				...
				<sf:input path="contact" id="phonenumber1"
					onblur="return phonenumber()" class="input-xlarge"

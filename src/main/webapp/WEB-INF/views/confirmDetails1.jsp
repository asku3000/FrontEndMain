	...
	<div class="content">
		<fieldset>
			...
			<sf:form modelAttribute="user">
				...
				<sf:label path="supplier_companyName">Comapany Name : </sf:label>${user.supplier_companyName}
					
				<hr>
				<br />
				<br />
				
				<sf:label path="supplier_brandName">Company Brand Name : </sf:label>${user.supplier_brandName}
